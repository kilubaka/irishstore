        ...
        <div class="size-chart" id="sizeChart"
            data-bind="mageInit: {
                'Magento_Ui/js/modal/modal':{
                    'type': 'popup',
                    'title': 'Donegal Merino Blasket Honeycomb Stitch Aran Sweater - Size Chart',
            ...
            <div class="size-chart-content">
                <div class="tabs-content" data-mage-init='{"mage/tabs": {"openedState": "active", "animate": {"duration": 100}, "active": 0, "closedState": "disabled"}}'>
                    <div class="tab-button in" data-role="collapsible">
                        <a class="tab-link-in" data-toggle="trigger" href="#in">Inches</a>
                    </div>
                    <div class="tab-button cm" data-role="collapsible">
                        <a class="tab-link-cm" data-toggle="trigger" href="#cm">Centimeters</a>
                    </div>

                    <table class="table_size" id="cm" data-role="content">
                        <tbody>
                            <tr>
                    ...
                    <table class="table_size" id="in" data-role="content">
                        <tbody>
                            <tr>
                                <th><strong>Our Sizing</strong></th>
                                <th><strong>XS</strong></th>
